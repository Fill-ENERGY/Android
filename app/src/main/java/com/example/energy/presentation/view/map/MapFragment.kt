...
class MapFragment : BaseFragment<FragmentMapBinding>({ FragmentMapBinding.inflate(it) }) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        var accessToken = "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6Imtpaml3aTFAbmF2ZXIuY29tIiwiaWF0IjoxNzIzODczNzk1LCJleHAiOjE3MjY0NjU3OTV9.XCE8KBKnNX358LtWQmSuDuo9eNHl_fdZznYk0yxs70M"
        if (accessToken != null) {
